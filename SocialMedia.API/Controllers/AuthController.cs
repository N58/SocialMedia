...
public class AuthController : ControllerBase
{
    ...
    {
        if (string.IsNullOrWhiteSpace(returnUrl)) returnUrl = "http://localhost:5173/"; // TODO SET IT FROM APPSETTINGS
    ...
    public async Task<IActionResult> GoogleCallback()
    {
        ...
        return Redirect(returnUrl ?? "http://localhost:5173/"); // TODO SET IT FROM APPSETTINGS
    }
    ...
    {
        if (string.IsNullOrWhiteSpace(returnUrl)) returnUrl = "http://localhost:5173/";
